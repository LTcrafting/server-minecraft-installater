...
**`5`** Le programme vous demande si vous voulez qu'il se supprime, si vous souhaitez qu'il se supprime car il ne servira plus à rien, tapez `Y`. Si vous voulez le garder tapez `N`
